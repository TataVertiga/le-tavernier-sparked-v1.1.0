...
export default {
  ...
  async execute(interaction: ChatInputCommandInteraction) {
    const embed = new EmbedBuilder()
      ...
      .addFields(
        { name: "📜 `/help`", value: "→ Affiche ce menu, abruti." },
        { name: "🧠 `/douzinite`", value: "→ Analyse si t’as pas causé avec ton fondement." },
        { name: "💨 `/prout`", value: "→ Lâche un pet... sonore." },
        { name: "👋 `/bonjour`", value: "→ Souhaite la bienvenue à ta façon, gueux." },
        { name: "🎂 `/anniv`", value: "→ Gère les anniversaires dans la Taverne." },

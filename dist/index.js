...
import { deploySlashCommands, loadEvents, loadSlashCommands, registerManualEvents, registerPresence, registerSlashHandler, } from "./core/discordSetup.js";
...
async function boot() {
    ...
    if (!token)
        throw new Error("DISCORD_TOKEN (ou TOKEN) manquant");
    ...
    if (serviceReadiness("tiktok").ready)
        markService("tiktok", "running");
